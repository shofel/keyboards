...
combo_t key_combos[] = {
  ...
  [CMB_CTL]       = COMBO(lctl_combo, OS_CTL),
  [CMB_LT2]       = COMBO(llt2_combo, OSL(L_NUM_NAV)),
  [CMB_ALT]       = COMBO(lalt_combo, OS_ALT),
  [CMB_GUI]       = COMBO(lgui_combo, OS_GUI),
};
